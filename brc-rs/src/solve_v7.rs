...
fn parse_temperature(reader: &mut RawBufReader) -> i16 {
  let mut temperature_value: i16 = 0;
  ...
  while c != b'\n' {
    if c == b'-' {
      ...
      temperature_value = (c - b'0') as i16 + 10 * temperature_value;
    }
    c = reader.next_char();
  }
...
/// switch to use i16 whenever possible
pub fn solve_v7() {
